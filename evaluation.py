...
def format_result(psnr, ssim, lpips):
    return f'{psnr:0.3f}, {ssim:0.4f}, {lpips:0.4f}'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default=r'G:\low-light_image_enhancement\dataset\MIT\test\high', type=str)
    #LOL G:\low-light_image_enhancement\Our\dataset\LOL\eval15\high
    #MIT G:\low-light_image_enhancement\dataset\MIT\test\high
    #LOLv2  G:\low-light_image_enhancement\Our\dataset\LOL-v2\test\high
    parser.add_argument('-dirB', default=r'G:\low-light_image_enhancement\Github\MRUNet\results\MIT\test', type=str)
